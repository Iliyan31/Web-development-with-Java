package bg.fmi.course.WebJavaWeek04.task1.service.dealership;

import bg.fmi.course.WebJavaWeek04.task1.model.car.Car;
import bg.fmi.course.WebJavaWeek04.task1.model.invoice.Invoice;
import bg.fmi.course.WebJavaWeek04.task1.service.CarService;
import bg.fmi.course.WebJavaWeek04.task1.service.InvoiceService;
...
public class Dealership {
    ...
    @Autowired
    public Dealership(String dealershipName, @Qualifier("carService") CarService carService,
